...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="policy-container">
      ...
      <h2>Introduction</h2>
      <p>
        Welcome to Mobiiwrap. We value your privacy and are committed to
        protecting your personal information. This Privacy Policy outlines how
        we collect, use, and safeguard your data when you visit our website and
      ...
      <ul>
        <li>
          ...
          attempt to make a purchase through Mobiiwrap, we collect certain
        ...
        <li>
          ...
          browser type, and operating system. We use cookies and similar
          tracking technologies to collect this information.
        </li>
        <li>
          <strong>Order Information:</strong> When you place an order, we
          collect information related to your purchase, including product
          details, purchase date, and order number.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>Communicate with you about your order status, products, and promotional offers.</li>
      ...
      <p>We respect your privacy and do not sell your personal information to third parties. However, we may share your information with third parties in the following circumstances:</p>
      <ul>
        <li>
          <strong>Service Providers:</strong> We engage third-party service
          providers to perform functions on our behalf, such as payment
          processing, shipping, and marketing services.
        </li>
        <li>
      ...
      <p>
        ...
        your browser settings. For more information, please see our Cookie
        Policy.
      </p>
      ...
      <p>
        <strong>Mobiiwrap</strong>  
        <br />
        Email: <a href="mailto:mobiiwrapshopify@gmail.com">[mobiiwrapshopify@gmail.com]</a>  
        <br />
        Address: [Mobiiwrap, shop no. 38, near Narang shoes, Ghaffar Market, Block 24N, Karol Bagh, New Delhi, Delhi 110005]
      </p>
