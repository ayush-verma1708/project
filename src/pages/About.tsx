      ...
      >
        ...
        >
          {timeline.map((item, index) => (
            ...
            >
              {/* Circle with Icon */}
              <div className="relative w-14 h-14 rounded-full bg-indigo-600 flex items-center justify-center text-white shadow-lg hover:scale-110 transition-transform">
                <item.icon size={28} />
              </div>
              {/* Content */}
              <motion.div
