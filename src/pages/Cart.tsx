        ...
        {state.items.length === 0 ? (
          ...
          <div className="space-y-4">
            {state.items.map((item) => (
              <div key={item._id} className="flex gap-4 bg-white p-4 rounded-lg shadow-md">
                <img
                  src={item.images[0]}
                  alt={item.name}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-4">
              ...
              <div>
                <Link
                  to="/checkout"
                  className="flex items-center justify-center gap-2 w-full bg-white-600 text-black py-3 rounded-lg hover:bg-black-700 transition-colors"
                >
