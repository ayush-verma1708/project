...
//       >
//         <span className="text-lg font-light tracking-wide text-black/80 group-hover:text-black transition-colors">
//           {faq.question}
//         </span>
//         <ChevronDown 
//           className={`w-5 h-5 text-black/60 transition-transform duration-300 ${open ? 'rotate-180' : ''}`}
//         />
//       </button>
//       {open && (
//         <motion.div
...
//           className="mt-4 text-base text-black/60 tracking-wide"
//         >
//           {faq.answer}
//         </motion.div>
//       )}
...
//         <h2 className="text-3xl md:text-4xl font-light tracking-[0.2em] uppercase mb-6">
