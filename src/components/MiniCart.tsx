...
// //   const handleDecreaseQuantity = (item: CartItem) => {
// //     if (item.quantity === 1) {
// //       setShowConfirmDialog(item); // Show confirmation before removing
// //     } else {
// //       updateQuantity(item.id, item.quantity - 1, item.selectedBrand, item.selectedModel);
// //     }
// //   };
  
  
// //   const handleRemoveItem = (item: CartItem) => {
// //     removeItem(item.id, item.selectedBrand, item.selectedModel); // Remove item from cart
